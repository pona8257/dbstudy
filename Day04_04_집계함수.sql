...
INSERT INTO SAMPLE_TBL(NAME, KOR, ENG, MAT) VALUES('미희', 80, NULL, 90);
...
/*  이름  국어 영어 수학  합계(1번) : SUM으로 못 구한다
    NULL, 100, 100, 100    300 
    '정숙', NULL, 90, 90   180
    '미희', 80, NULL, 90   170
    '철수', 70, 70, NULL   140
    --------------------------
    합계   250   260   280  2번 : SUM으로 구할 수 있다
*/
...
-- 개수
SELECT 
        COUNT(KOR)  -- 국어 시험 응시한 인원 수
      , COUNT(ENG)  -- 영어 시험 응시한 인원 수
      , COUNT(MAT)  -- 수학 시험 응시한 인원 수
